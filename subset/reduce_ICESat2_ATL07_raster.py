...
# PURPOSE: read ICESat-2 sea ice data (ATL07)
...
def reduce_ICESat2_ATL07_raster(FILE,
    ...
    for gtx in sorted(IS2_atl07_beams):
        ...
        # output mask to HDF5
        IS2_atl07_mask[gtx]['sea_ice_segments']['subsetting'][MASK_NAME] = interp_mask.copy()
        IS2_atl07_fill[gtx]['sea_ice_segments']['subsetting'][MASK_NAME] = None
        IS2_atl07_dims[gtx]['sea_ice_segments']['subsetting'][MASK_NAME] = ['delta_time']
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME] = {}
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['contentType'] = \
            "referenceInformation"
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['long_name'] = 'Mask'
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['description'] = \
            'Mask calculated using raster image'
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['source'] = MASK.name
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['sigma'] = SIGMA
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['tolerance'] = TOLERANCE
        IS2_atl07_mask_attrs[gtx]['sea_ice_segments']['subsetting'][MASK_NAME]['coordinates'] = \
            "../height_segment_id ../delta_time ../latitude ../longitude"
