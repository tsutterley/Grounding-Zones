...
def main():
	...
	#-- run program
	scp_ICESat2_files(client, client_ftp, base_dir, remote_dir, PRODUCT,
...
def scp_ICESat2_files(client, client_ftp, base_dir, remote_dir, PRODUCT,
	...
	REMOTE=posixpath.join(remote_dir,'icesat2.dir','{0}.dir'.format(PRODUCT))
	...
	if PUSH:
		...
		for sub in sorted(SUBDIRECTORY):
			...
			remote_sub = ['icesat2.dir','{0}.dir'.format(PRODUCT),sub]
