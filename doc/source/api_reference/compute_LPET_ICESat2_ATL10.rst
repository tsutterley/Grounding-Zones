...
.. __: https://github.com/tsutterley/Grounding-Zones/blob/main/tides/compute_LPET_ICESat2_ATL10.py

.. argparse::
    :filename: ../../tides/compute_LPET_ICESat2_ATL10.py
    :func: arguments
    :prog: compute_LPET_ICESat2_ATL10.py
    :nodescription:
    :nodefault:
