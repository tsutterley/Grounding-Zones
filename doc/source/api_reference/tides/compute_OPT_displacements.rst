...
- Calculates radial ocean pole load tide displacements for an input file following :cite:t:`Petit:2010tp`
...
.. __: https://github.com/tsutterley/Grounding-Zones/blob/main/tides/compute_OPT_displacements.py
