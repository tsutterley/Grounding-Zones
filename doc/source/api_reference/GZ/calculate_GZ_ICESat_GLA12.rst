...
- Calculates ice sheet grounding zones using ICESat/GLAS L2 GLA12 Antarctic and Greenland Ice Sheet elevation data data following [Brunt2010]_ [Fricker2006]_ [Fricker2009]_

`Source code`__

.. __: https://github.com/tsutterley/Grounding-Zones/blob/main/GZ/calculate_GZ_ICESat_GLA12.py

Calling Sequence
################

.. argparse::
    :filename: calculate_GZ_ICESat_GLA12.py
    :func: arguments
    :prog: calculate_GZ_ICESat_GLA12.py
    :nodescription:
    :nodefault:
