...
# PURPOSE: read ICESat-2 ocean surface height (ATL12)
...
def compute_tides_ICESat2(tide_dir, INPUT_FILE,
    ...
    for gtx in IS2_atl12_beams:
        lon = IS2_atl12_mds[gtx]['ssh_segments']['longitude']
        lat = IS2_atl12_mds[gtx]['ssh_segments']['latitude']
    ...
    for gtx in sorted(IS2_atl12_beams):
        ...
        X, Y = ds.tmd.coords_as(val['longitude'], val['latitude'],
            crs=4326, type='drift')
        ...
        IS2_atl12_fill[gtx]['ssh_segments']['stats'][model.atl12] = fv
    ...
    HDF5_ATL12_tide_write(IS2_atl12_tide, IS2_atl12_tide_attrs,
        ...
        INPUT=GRANULE,
        FILL_VALUE=IS2_atl12_fill,
        DIMENSIONS=IS2_atl12_dims,
        CLOBBER=True)
