...
def compute_OPT_ICESat(INPUT_FILE,
    ...
    try:
        ...
        FILENAME = f'{INPUT_FILE.stem}_OPT{INPUT_FILE.suffix}'
    else:
    ...
    IS_gla12_tide['Data_40HZ']['Geophysical']['d_opElv'] = Urad.fillna(fv)
    IS_gla12_fill['Data_40HZ']['Geophysical']['d_opElv'] = fv
