...
# PURPOSE: read ICESat-2 sea ice freeboard (ATL10)
...
def compute_tides_ICESat2(tide_dir, INPUT_FILE,
    ...
    for gtx in IS2_atl10_beams:
        ...
        for group in ['freeboard_beam_segment','leads']:
            lon = IS2_atl10_mds[gtx][group]['longitude']
            lat = IS2_atl10_mds[gtx][group]['latitude']
    ...
    for gtx in sorted(IS2_atl10_beams):
        ...
        for group in ['freeboard_beam_segment','leads']:
            ...
            IS2_atl10_fill[gtx][group]['geophysical'][model.atl10] = fv
